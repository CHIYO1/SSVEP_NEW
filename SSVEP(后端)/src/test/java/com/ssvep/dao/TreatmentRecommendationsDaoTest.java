...
public class TreatmentRecommendationsDaoTest {
    ...
    public void testSaveRecommendation() {
        ...
        map.put("Export",123);
        TreatmentRecommendations recommendation = new TreatmentRecommendations(4L, map);
    ...
    public void testDeleteRecommendation() {
        TreatmentRecommendations recommendation = new TreatmentRecommendations(3L, null);
        recommendationsDao.save(recommendation);
